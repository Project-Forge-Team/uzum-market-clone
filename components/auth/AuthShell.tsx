...
const BENEFITS = [
  "Товары, отзывы и заказы — в локальной базе",
      ...
      <aside className="hidden flex-col justify-between rounded-3xl bg-ink p-7 text-white lg:flex">
        <div>
          ...
          <p className="mt-3 text-[14px] leading-relaxed text-white/70">
            Войдите, чтобы оставлять отзывы и оформлять заказы, и сразу
            получайте кабинет продавца: публикация товаров, остатки, ответы
            покупателям.
          </p>
